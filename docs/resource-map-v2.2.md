...
# RESOURCE MAP v2.2 ADDENDUM — 24 July 2026 (freebie layer)

*Appended to Resource Map v2.1.*

## THE FREEBIE LAYER

Every pillar now has a dedicated lead-magnet page. This is the free-resource layer that replaces the shared Blueprint fallback in each pillar's journey block.

| # | Pillar | Freebie | Route | Upsell |
|---|--------|---------|-------|--------|
| 1 | AI | The AI Starter Kit | `/resources/ai-starter-kit` | 8 Claude Prompts ($5) |
| 2 | Pinterest | The Pinterest Traffic Kit | `/resources/pinterest-traffic-kit` | Pinterest Batching guide ($9) |
| 3 | Content Creation | The Content Creation Kit | `/resources/content-creation-kit` | Tommy Kate Edit™ |
| 4 | Digital Products | The First Product Kit | `/resources/digital-products-kit` | Pretty & Paid PLR Vault™ ($11/mo) |
| 5 | Affiliate | The Affiliate Starter Kit | `/resources/affiliate-starter-kit` | Leni Loves Collage Edit™ ($27) |
| 6 | Automation | The Automation Starter Kit | `/resources/automation-kit` | VIP membership |
| 7 | Email | The Email List Starter Kit | `/resources/email-starter-kit` | Email Edit™ / Premium ($9) |
| 8 | Branding | The Brand Clarity Kit | `/resources/branding-kit` | Brand module / Premium ($9) |
| 9 | Business Systems | The Systems Starter Kit | `/resources/business-systems-kit` | Membership Premium ($9) |
| 10 | Passive Income | The Passive Income Starter Kit | `/resources/passive-income-kit` | Membership Premium ($9) |
| 11 | Mindset | The Creator to CEO Kit | `/resources/mindset-kit` | Membership Premium ($9) |
| 12 | Blogging | The Evergreen Blog Kit | `/resources/blogging-kit` | Membership Premium ($9) |

**Capture:** all twelve + `/newsletter` post to one MailerLite form (account 2532349), one list, Option 1. Segmentation deferred.

**Delivery:** page-is-the-freebie. No emailed asset yet (Decision 76).

**Component:** `src/components/FreebieForm.astro` — shared capture form; change the action URL there to swap capture behaviour globally.
